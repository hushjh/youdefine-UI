...
var injectMixins = function injectMixins() {
...
var YnDropdownMenuItem = defineComponent({
  ...
  methods: {
    ...
    hasOptions: function hasOptions() {
      ...
      return isObject$1(options) && typeof options.action === "function" || Array.isArray(options) && options.length > 0 || this.slots().length > 0;
    },
        ...
        if (this.selections.length > 0) {
          return [h("ul", {}, Array.apply(null, this.selections).map(function (option, key) {
            return h("li", {
              ...
              class: ["text"]
            }, option.text)]), h(genComponentName("flex-item"), {}, [h(genComponentName("iconfont"), {
              class: ["confirm-mark"],
              directives: [{
                name: "show",
  ...
  mounted: function mounted() {
    ...
    if (isObject$1(this.options) && typeof this.options.action === "function") {
...
var index$1 = install(YnDropdownMenuItem);
