...
setSpecies('RegExp'); // `SameValue` abstract operation
...
var YnSpin = defineComponent({
  ...
  methods: {
    loadSubComponent: function loadSubComponent() {
      ...
      try {
        var component = require("./shapes/".concat(capitalizeName, "/index.js"));
...
var Spin = install(YnSpin);
var CACHED_ALPHA_BETA = {};
var YnCityPicker = defineComponent({
  name: "CityPicker",
  ...
  methods: {
    ...
    creteHeaderArea: function creteHeaderArea(h) {
      ...
      if (this.caculatedTabs.length === 2) {
        header.push(h(genComponentName("flex"), {
          props: {
    ...
    createAlphaBeta: function createAlphaBeta(h) {
      ...
      return [this.createBlockTitle(h, this.alphaBeta.title), h(genComponentName("flex"), {
        props: {
          flexWrap: "wrap",
    ...
    creteInputSearchArea: function creteInputSearchArea(h) {
      if (this.searchable) {
        return h(genComponentName("flex"), {
          props: {
            justifyContent: "spaceBetween"
          },
    ...
    createDynamicContent: function createDynamicContent(h) {
      if (this.limited) {
        ...
        }, [this.createTitle(h), this.createClose(h)]), h(genComponentName("flex-item"), {
          props: {
            flex: 1
          }
        }, [this.createBlock(h, {
        ...
        return [h(genComponentName("flex-item"), {
          class: ["yn-city-picker-header"]
        }, this.creteHeaderArea(h)), h(genComponentName("flex-item"), {
          directives: [{
            name: "show",
        ...
        }, [this.createBodyArea(h)]), h(genComponentName("flex-item"), {
          directives: [{
            name: "show",
        ...
        }, [this.createInputSearchList(h)]), h(genComponentName("flex-item"), {
...
var index$1 = install(YnCityPicker);
