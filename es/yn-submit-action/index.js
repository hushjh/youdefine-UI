...
var YnSubmitAction = defineComponent({
  name: "SubmitAction",
  mixins: [slotsMixins],
  components: {
    Flex: Flex,
  ...
  render: function render(h) {
    ...
    }, [this.getValideContent("content", slots)])])]), h(genComponentName("flex"), {
    ...
    }, [h(genComponentName("flex"), {}, [h(genComponentName("flex-item"), {}, [h("span", {
      class: ["yn-submit-action-total-text"]
    }, [this.label])]), h(genComponentName("flex-item"), {}, [this.genValue(h, slots)]), h(genComponentName("flex-item"), {}, [this.genIcon(h)])])]), h(genComponentName("flex-item"), {
      props: {
        flex: 1
      }
...
var index$1 = install(YnSubmitAction);
