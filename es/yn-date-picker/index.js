...
var now$1 = YnDate().getToday();
var year = now$1.getFullYear();
var m = now$1.getMonth();
var month = m < 10 ? "0".concat(m) : m;
var d = now$1.getDate();
var date = d < 10 ? "0".concat(d) : d;
var YnDatePicker = defineComponent({
  name: "DatePicker",
  components: {
    Picker: Picker
  },
  props: {
    ...
    start: {
      type: String,
      default: "".concat(year - 100, "-").concat(month, "-").concat(date)
    },
    end: {
      type: String,
      default: "".concat(year, "-").concat(month, "-").concat(date)
    },
    defaultDate: String
  },
  data: function data() {
...
var index$1 = install(YnDatePicker);
