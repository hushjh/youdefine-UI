...
var setToStringTag = function setToStringTag(it, TAG, STATIC) {
  if (it && !has(it = STATIC ? it : it.prototype, TO_STRING_TAG$2)) {
    defineProperty$3(it, TO_STRING_TAG$2, {
      configurable: true,
      value: TAG
    });
  }
...
var Remainder = /*#__PURE__*/function () {
...
var VALID_CHILD_COMPONENT = "swipe-item";
var YnSwipe = defineComponent({
  name: "Swipe",
  components: {
    Popup: Popup
  },
  ...
  methods: {
    ...
    updateActivedIndex: function updateActivedIndex(num, callback) {
      var _this7 = this; // 正在运动的时候不允许连续点击
    ...
    getSwipper: function getSwipper(h, slots) {
      ...
      if (this.fullScreen) {
        return [h(genComponentName("popup"), {
          on: {
