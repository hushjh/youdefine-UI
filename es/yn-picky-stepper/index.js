...
var YnButton = defineComponent({
  ...
  methods: {
    ...
    createIcon: function createIcon(h) {
      ...
      if (this.iconName) {
        icon.push(h(genComponentName("iconfont"), {
          props: {
            name: this.iconName,
            size: this.iconSize
          }
...
var Button = install(YnButton);
var YnRadiobox = defineComponent({
  name: "Radiobox",
  props: {
    checked: {
      type: Boolean,
...
var Radiobox = install(YnRadiobox);
var YnCheckbox = defineComponent({
  name: "Checkbox",
  components: {
    Iconfont: Iconfont
  },
...
var Checkbox = install(YnCheckbox);
...
var YnPickyStepper = defineComponent({
  name: "PickyStepper",
  components: {
    Popup: Popup,
    Iconfont: Iconfont,
    ...
    createPickerList: function createPickerList(h, step, stepIndex) {
      ...
      return h("div", {
        ...
        return h("li", {
          ...
          key: key
        }, [h(genComponentName("flex"), {}, [h(genComponentName("flex-item"), {}, [step.multiple ? h(genComponentName("checkbox"), {
          props: {
            checked: item.checked,
            size: 20
          }
        }, []) : h(genComponentName("radiobox"), {
          props: {
            checked: item.checked,
            size: 20
          }
        }, [])]), h(genComponentName("flex-item"), {}, [h("span", {
          class: ["text"]
...
var index$1 = install(YnPickyStepper);
