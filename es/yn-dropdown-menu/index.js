...
var provideMixins = function provideMixins() {
...
var VALID_CHILD_COMPONENT$1 = "dropdown-menu-item";
var YnDropdownMenu = defineComponent({
  name: "DropdownMenu",
  ...
  methods: {
    validChildComponent: function validChildComponent() {
      var prefix = this.VUE_APP_PREFIX;
      var validChildComponent = VALID_CHILD_COMPONENT$1;

      if (prefix !== "") {
        validChildComponent = "".concat(prefix, "-").concat(VALID_CHILD_COMPONENT$1);
      }
    ...
    createMenu: function createMenu(h, slots) {
      ...
      return h("div", {
        ...
        return h(genComponentName("flex-item"), {
          ...
          key: key
        }, [h("span", {}, text), h(genComponentName("iconfont"), {
          directives: [{
            name: "show",
...
var index = install(YnDropdownMenu);
